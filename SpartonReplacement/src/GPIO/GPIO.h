...
/** @brief Attaches Pull-up or Pull-down Resistor
 * 
 * Attaches a Pull-up or Pull-down resistor to digital out pin
 * 
 * @param Port GPIO Port output pin is located on
 * @param Pin GPIO Pin output is located on
 * @param Type Type of resistor to add (0 - Pull-down, 1 - Pull-up)
 * @param Enable Enable or disable resistor (0 - Disable, 1 - Enable)
 * 
 * @return none
 */
uint8_t GPIO_AttachResistor(uint8_t Port, uint16_t Pin, uint8_t Type, uint8_t Enable);
